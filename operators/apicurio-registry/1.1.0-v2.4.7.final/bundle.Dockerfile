...
COPY bundle/1.1.0-v2.4.7.final/manifests /manifests/
COPY bundle/1.1.0-v2.4.7.final/metadata /metadata/
COPY bundle/1.1.0-v2.4.7.final/tests/scorecard /tests/scorecard/
